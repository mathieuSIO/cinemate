...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchmovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=ebdf19d8f899bda652f96f85dc1f76a6`);
  ...
  return (
    <main id="main">
      <section className="flex justify-around flew-wrap py-5">
        <div className="max-w-sm">
          <img className="rounded" src={image} alt="eaz" />
        </div>
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <div className="flex items-center">
            ...
            <p className="ms-2 text-heading dark:text-white">{movie.vote_average}</p>
